...
from longstream.greedy_stopgrad_schedule_updated import GreedyStopGradController
from longstream.eval_longstream_compat import (
    eval_CIL_ptKappa_taskwise,
    eval_CIL_ptKappa_znorm_taskwise,
)
...
def train_tasks(
    ...
    for t_idx, (train_loader, test_loader) in enumerate(tasks_data):
        ...
        k_start = min(capacity_left, kappa_peak[t_idx])
        epoch_counter = 0
...
if __name__ == "__main__":
    ...
    kappa_initials = _build_capacity_aware_kappa_initials(
        n_tasks=n_tasks,
    ...
    for dataset in datasets:
        if dataset == 'CIF10':
            ...
            tasks_data = generate_split_tiny_imagenet(
                ...
                n_tasks=n_tasks, batch_size=batch_size, num_workers=4,
