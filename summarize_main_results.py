#!/usr/bin/env python3
"""Summarise main-result CSV logs arranged as dataset/architecture/step.
...
def main() -> int:
    ...
    output_dir = (
        ...
        else (input_dir / "main_results_summary").resolve()
    )
    ...
    write_dict_csv(
        output_dir / "main_results_runs.csv",
        [
            "dataset",
            "architecture",
            "step",
    ...
    write_dict_csv(
        output_dir / "main_results_by_directory.csv",
        [
            "dataset",
            "architecture",
            "step",
    ...
    write_dict_csv(
        output_dir / "main_results_paper_table.csv",
        combined_fields,
        combined_rows,
    )
    ...
    if len(architectures) == 1:
        write_rows(
            output_dir / "main_results_paper_table_multiheader.csv",
